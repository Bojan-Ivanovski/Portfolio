const info = [
    ...
    [
        {
            Title:"Starphone API",
            Description:"The project was assigned by Stonebranch as a final project after the Python Backend course at Semos Education. The task of the project was to make an  API with python and flask which will generate test data and statistics through given CSV files which are validated to generate correct data and statistics.",
        },
        {
