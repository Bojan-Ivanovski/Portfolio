...
export default function Home(props)
{
    ...
    return(
        ...
        <div className="w-full h-full flex justify-center items-center">
            ...
            <div onClick={() => {props.setMode(val => !val); setHovered(false)}} onMouseEnter={()=> setHovered(true)} onMouseLeave={()=> setHovered(false)} className="z-[101] absolute w-full h-32 text-4xl opacity-0 cursor-pointer">Bojan Ivanovski</div>
            
            
            <div className="flex flex-col items-center">
                <p className="text-2xl">Hover Over Me</p>
